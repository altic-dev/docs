...
<CardGroup cols={2}>
  <Card title="Smart Formatting" icon="align-left">
  ...
  <Card title="Dates, Names & Numbers" icon="calendar">
  ...
  <Card title="Filler Word Removal" icon="eraser">
