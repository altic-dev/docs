...
<CardGroup cols={2}>
  <Card title="Fluid Intelligence" icon="microchip">
  ...
  <Card title="Groq" icon="bolt">
    **Cloud · API key required**
    ...
    Fast inference via Groq's LPU hardware. Good balance of speed and quality for real-time dictation enhancement.
  </Card>
  <Card title="Custom Provider" icon="server">
