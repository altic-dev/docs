...
Beyond Fluid Intelligence, you can connect OpenAI, Groq, or a custom provider for cloud-based post-processing through the [AI Enhancement](https://app.mintlify.com/fluidvoice/fluidvoice/editor/main/~/8d613e06-4bba-4171-b81a-39e9fd030239) page. API keys are stored in macOS Keychain and never logged or transmitted by the app itself. See our <u>privacy info</u> for more information.
