...
<CardGroup cols={2}>
  <Card title="New to FluidVoice, Apple Silicon" icon="bolt">
  ...
  <Card title="English-only power user" icon="gauge-high">
  ...
  <Card title="Multilingual or non-European language" icon="language">
  ...
  <Card title="Intel Mac" icon="microchip">
  ...
  <Card title="Tight on disk space" icon="hard-drive">
  ...
  <Card title="Best accuracy, cost no object" icon="star">
